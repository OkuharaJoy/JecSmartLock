    ...
    <main>
        <div class="content">
            <div class="container">
                <h2>教室管理</h2>
                <div class="tag">
                    <input type="text" id="searchQuery" class="search-box" placeholder="教室番号を入力して検索" onkeyup="filterTable()">
                ...
                <div class="edit_user" id="edit_user1"  style="display: none; opacity: 0;">
                    <form>
                        ...
                        <div class="button-container">
                            <button type="button" onclick="closeModal('edit_user1')">閉じる</button>
                            <button id="editRoom" type="button">更新</button>
                        </div>
                    </form>
                </div>
                ...
                <div class="edit_user" id="deleteKey" style="display:none;">
                    <form>
                        ...
                        <div class="button-container">
                            <button type="button" onclick="closeModal('deleteKey')">閉じる</button>
                ...
                <div class="create_user" id="create_key" style="display:none;">
                    ...
                    <form method="POST" enctype="multipart/form-data">
                        ...
                        <button class="register-btn" type="button" id="keyCreate">登録</button>
                    </form>
                            ...
                            <?php if (!empty($classrooms)): ?>
                                <?php foreach ($classrooms as $classroom): ?>
                                    <tr>
                                        ...
                                        <td>
                                            <button class="edit-btn" onclick="openEditRoom(
                                                {
                                            ...
                                            <!-- <button class="edit-btn" onclick="openModal('deleteKey')">削除</button> -->
                                                <button type="button" id="deleteRoom" 
                                                        ...
                                                        onclick="deleteRoom(this)">削除</button>

                                        </td>
                                        <td><button class="edit-btn" onclick="openCreateKey(
                                                {
                                                    'classroomid':'<?= $classroom['classroomID'] ?>'
                                                    // ,'id':'< ?= $classroom['id'] ?>',
                                                    // 'name':'< ?= $classroom['name'] ?>'
