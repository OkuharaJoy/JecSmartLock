    ...
    <div class="content">
        <div class="container">
            <div class="header">開閉状況    
                ...
                <ul>
                <ul>
                    <li><span class="dot dot-open">●</span> → <strong>開</strong></li>
                    <li><span class="dot dot-closed">●</span> → <strong>閉</strong></li>
                ...
                <div class="building-section">
                    <div class="building-toggle" data-classroom-id="<?= $RECENTLY['classroomId'] ?>" onclick="toggleRooms<?= $RECENTLY['classroomId'] ?>()">最近使用した教室
                    </div>
                    <div class="rooms-buttons"></div>
            ...
            <?php foreach($classrooms as $CLASSROOM){ ?>
                <?php if($id != $CLASSROOM['id']) { 
                    ...
                    <?php } ?>
                <div class="building-section">
                    <div class="building-toggle" data-classroom-id="<?= $CLASSROOM['id'] ?>" onclick="toggleRooms<?= $CLASSROOM['id'] ?>()"><?= $CLASSROOM['id'] ?>号館
                    </div>
                    <div class="rooms" id="rooms-container<?= $CLASSROOM['id'] ?>">
                        <div class="image-and-rooms">
                            ...
                            <div class="rooms-buttons">
                                ...
                                <style>
                                        .status-unregistered { background-color: #FFF3CD; } /* 柔らかい黄色 */
                                        .status-open { background-color: #F8D7DA; } /* 柔らかい赤 */
                                        .status-closed { background-color: #D1ECF1; } /* 柔らかい青 */
                                </style>

                                
<!-- 
                                    <button title="だだだ"  class="room-practice">
                                        <span class="classroom">< ?= $CLASSROOM['name'] ?></span><br>
                                        <span class="status">
                                            < ?php 
                                                $charStatus = trim($CLASSROOM['charStatus'] ?? '');
                                                // var_dump($CLASSROOM['charStatus']);
                                                if (is_null($CLASSROOM['charStatus'])) {
                                                    echo "未登録";
                                                } elseif($CLASSROOM['charStatus'] === "unlocked") {
                                                        echo "開";
                                            ...
                                            ?></span>
                                        <span class="status">< ?= $CLASSROOM['charStatus'] ?></span>
                                    </button> -->
                                </a>      
                                <?php  $id = $CLASSROOM['id']; ?>
                            <?php
